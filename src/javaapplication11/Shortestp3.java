...
public class Shortestp3 {
	...
	public static void main(String[] args) {
		Shortestp3 sp = new Shortestp3(new char[][] { 
                                 { '1', '1', '1', '1', '1' },
				{ 'S', 'X', 'X', '1', '1' }, 
                                 { 'X', '1', '1', '1', '1' },
				{ 'X', '1', 'X', 'E', '1' }, 
                	...
                	System.out.println(sp.matrix[3][2]);
                //	System.out.println(sp.matrix[2][3]);
